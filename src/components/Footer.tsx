    ...
    return (
      <footer className="footer-container">
        ...
        <div className="footer-content">
          <p>
            {" "}
            Thank you for ordering with us, we hope you had a great time and
            enjoyed our services. We look forward to serving you again soon!
          </p>
          <nav>
        ...
        <div className="footer-social">
          <p>
            {" "}
            2025@foodieland.com.{" "}
            <span className="color"> All rights reserved.</span>
          </p>
